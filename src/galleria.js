...
var G = window.Galleria = Base.extend({
    ...
    __constructor : function(options) {
        ...
        var elems = 'container stage images image-nav image-nav-left image-nav-right image-nav-home ' + 
    ...
    init: function() {
        ...
        this.bind(G.READY, function() {
            ...
            if (/^[0-9]{1,4}$/.test(hash) && G.History) {
                ...
                this.show(undefined, undefined, true);
    ...
    run : function() {
        ...
        this.wait(function() {
            ...
            this.listen(this.get(/*'image-nav-right'*/'thumb-nav-right'), 'click', this.proxy(function() {
                this.next();
            }));
            this.listen(this.get(/*'image-nav-left'*/'thumb-nav-left'), 'click', this.proxy(function() {
                this.prev();
            }));
            this.listen(this.get('image-nav-home'), 'click', this.proxy(function() {
                this.gohome();
            }));
    ...
    addCarousel : function(thumbWidth, thumbsWidth) {
        ...
        this.carousel = {
            right: this.get(/*'thumb-nav-right'*/'image-nav-right'),
            left: this.get(/*'thumb-nav-left'*/'image-nav-left'),
            overflow: 0,
    ...
    build : function() {
        this.append({
            ...
            'image-nav' : 
                [/*'image-nav-right', 'image-nav-left',*/ 'image-nav-home'],
            'stage' : 
    ...
    show : function(index, rewind, history) {
        ...
        if(index==undefined) {
			index=parseInt(document.location.hash.slice(1))-1;
    ...
    gohome : function() {
        //alert('test');
        window.location.assign(this.home_url);
        return this;
    },
